...
export default function StatsPanel() {
  ...
  return (
    <div className="stats-side">
      <div className="globe-card-bar stats-panel-bar">
        <span className="globe-card-title">Listening Stats</span>
      </div>
      <div className="stats-side-body">
        ...
        <div className="stats-rows">
          {countries.length === 0 ? (
            <div className="stats-row-empty">Nobody's tuned in yet — check back once someone loads a station.</div>
          ) : (
            countries.map((c) => (
